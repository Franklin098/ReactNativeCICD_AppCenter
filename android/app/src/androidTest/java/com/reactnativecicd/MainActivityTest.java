...
public class MainActivityTest {
    ...
    public void mainActivityTest2() {
        ...
        ViewInteraction textView = onView(
                allOf(withText("10 years from now you will still have $1000 but it will only be worth $0."),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))),
                        isDisplayed()));
        textView.check(matches(withText("10 years from now you will still have $1000 but it will only be worth $0.")));
    }

    @After
    public void TearDown(){
        // report center takes a piture to show it in AppCenter
